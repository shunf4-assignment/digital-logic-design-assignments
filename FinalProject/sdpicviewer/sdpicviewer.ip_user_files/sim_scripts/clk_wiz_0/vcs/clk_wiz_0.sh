...
#
# Generated by Vivado on Sat Dec 30 18:37:42 +0800 2017
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/clk_wiz_v5_3_1" \
    "$ref_dir/../../../../sdpicviewer.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../sdpicviewer.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
