...
#
# Generated by export_simulation on Mon Dec 11 13:00:56 +0800 2017
#
################################################################################
...
switch to the './mig_7series_ddr.sh' script.

./mig_7series_ddr.sh -reset_run
...
./mig_7series_ddr.sh -noclean_files

For more information on the script, please type './mig_7series_ddr.sh -help'.
