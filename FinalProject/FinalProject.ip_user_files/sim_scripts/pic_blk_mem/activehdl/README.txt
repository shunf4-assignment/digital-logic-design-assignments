...
#
# Generated by export_simulation on Fri Dec 15 21:52:40 +0800 2017
#
################################################################################
...
switch to the './pic_blk_mem.sh' script.

./pic_blk_mem.sh -reset_run
...
./pic_blk_mem.sh -noclean_files

For more information on the script, please type './pic_blk_mem.sh -help'.
