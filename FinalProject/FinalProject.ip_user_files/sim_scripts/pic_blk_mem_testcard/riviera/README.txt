...
#
# Generated by export_simulation on Sat Dec 16 17:00:10 +0800 2017
#
################################################################################
...
switch to the './pic_blk_mem_testcard.sh' script.

./pic_blk_mem_testcard.sh -reset_run
...
./pic_blk_mem_testcard.sh -noclean_files

For more information on the script, please type './pic_blk_mem_testcard.sh -help'.
