...
set_property PACKAGE_PIN V11 [get_ports {b[15]}]
set_property PACKAGE_PIN V12 [get_ports {b[14]}]
set_property PACKAGE_PIN V14 [get_ports {b[13]}]
set_property PACKAGE_PIN V15 [get_ports {b[12]}]
set_property PACKAGE_PIN T16 [get_ports {b[11]}]
set_property PACKAGE_PIN U14 [get_ports {b[10]}]
set_property PACKAGE_PIN T15 [get_ports {b[9]}]
set_property PACKAGE_PIN V16 [get_ports {b[8]}]
set_property PACKAGE_PIN U16 [get_ports {b[7]}]
set_property PACKAGE_PIN U17 [get_ports {b[6]}]
set_property PACKAGE_PIN V17 [get_ports {b[5]}]
set_property PACKAGE_PIN R18 [get_ports {b[4]}]
...
set_property PACKAGE_PIN N17 [get_ports sext]
